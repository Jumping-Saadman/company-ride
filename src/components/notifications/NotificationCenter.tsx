...
export function NotificationCenter() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute right-0 z-40 mt-2 w-80 rounded-xl border border-ink-200 bg-white shadow-xl sm:w-96">
            ...
            {notifications.length === 0 ? (
              ...
              notifications.slice(0, 20).map((n) => (
                <button
                  ...
                  className={`flex w-full items-start gap-2 border-b border-ink-50 px-4 py-3 text-left hover:bg-ink-50 ${
